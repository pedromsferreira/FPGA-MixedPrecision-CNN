...
BEGIN PROCESSOR
 ...
 PARAMETER extra_compiler_flags = -g -ffunction-sections -fdata-sections -Wall -Wextra -fno-tree-loop-distribute-patterns  -Os -flto -ffat-lto-objects
END
...
BEGIN DRIVER
 ...
 PARAMETER HW_INSTANCE = axi_dma_w2
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = axidma
 PARAMETER DRIVER_VER = 9.15
 PARAMETER HW_INSTANCE = axi_dma_w4
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = conv
 PARAMETER DRIVER_VER = 1.7
 PARAMETER HW_INSTANCE = conv_0
END

BEGIN DRIVER
 PARAMETER DRIVER_NAME = conv_w2
 PARAMETER DRIVER_VER = 1.7
 PARAMETER HW_INSTANCE = conv_w2
END
