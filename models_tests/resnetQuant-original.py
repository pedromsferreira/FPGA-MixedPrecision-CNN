...
class ResNetQuant(nn.Module):
	def __init__(self, block, num_blocks, num_classes=10):
		...
		self.linear = qnn.QuantLinear(512*block.expansion, num_classes, bias=False, weight_bit_width=weightBitWidth, bias_quant=BiasQuant, weight_quant=CustomWeightQuant, return_quant_tensor=False)
