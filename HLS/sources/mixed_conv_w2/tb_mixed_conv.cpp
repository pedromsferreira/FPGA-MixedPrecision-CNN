...
#define TB_NUM_FILTERS 256
#define TB_NUM_KERNEL 128
...
#define PRINT_OK_RESULT true
#define PRINT_OK true
#define HW_ON 1
#define DO_SHORTCUT 0

char*	weights_file = "/home/pferreira/deepL/pytorch-cifar/weightsExtractor/output/0010layer3[0].conv1.weight.bin";
char*	acts_file = "/home/pferreira/HwSw/HLS/outputs/output_L2_B1_C2_hw.bin";
...
// char*	acts_file = "/home/pferreira/HwSw/Vitis/datasets/cifar-10-binary/img_17_horse.bin";
char*   output_map_file = "/home/pferreira/HwSw/HLS/outputs/output_L3_B0_C1_hw.bin";
char*   output_map_file_sw = "/home/pferreira/HwSw/HLS/outputs/output_L3_B0_C1_sw.bin";
...
int main()
{
	...
	//		printf("%X\n",tmp.data.range((DMA_WIDTH/4)-1,0).to_int());
		...
		conv_w2(str_in, str_out,TB_NUM_FILTERS,TB_NUM_KERNEL,TB_INPUT_MAP_SIZE,TB_INPUT_MAP_SIZE,ctrl);
