...
#define MAX_IN_IMAGE_SIZE (32 + MAX_PADDING*2)
#define MAX_OUT_IMAGE_SIZE (32 + MAX_PADDING*2)
#define MAX_NUM_FILTERS 128 //max for ResNet50 at halfway point
#define MAX_NUM_KERNELS 128 //max for ResNet50 at halfway point
...
//#define MAX_WEIGHTS_MEM_SIZE ((8192/NUM_PE)/NUM_WEIGHTS_IN_BUS) //max filter has 3*3*512=4608 weights -> next base 2 is 8192
#define MAX_WEIGHTS_MEM_SIZE ((4608/NUM_PE)*WEIGHTS_ACTS_RATIO) //max needed is x*y*filters*kernels/numWeightsInBus = 3*3*128*128/32=4608 bus -> next base 2 is 8192
...
//int ID_READ_TABLE_S2[5] = {0,2,4,1,3};
