...
#define TB_NUM_FILTERS 32
#define TB_NUM_KERNEL 16
#define TB_KERNEL_SIZE 3
#define TB_INPUT_MAP_SIZE 16
#define TB_STRIDE 1
#define TB_PADDING 1
...
#define HW_ON 1
#define DO_SHORTCUT 1
#define TB_OUT_SCALE_MAP1 4
#define TB_OUT_SCALE_MAP2 5
#define TB_MAP2_SIGNED 0
...
char*	acts_file_sum = "/home/pferreira/HwSw/HLS/outputs/conv1.bin";
...
char*   output_map_file = "/home/pferreira/HwSw/HLS/outputs/output_L1_B0_C2_sh_hw22222.bin";
char*   output_map_file_sw = "/home/pferreira/HwSw/HLS/outputs/output_L1_B0_C2_sh_sw222222.bin";
...
int main()
{
	...
	//		printf("%X\n",tmp.data.range((DMA_WIDTH/4)-1,0).to_int());
		...
		int ctrl=(TB_PADDING)+(TB_KERNEL_SIZE<<3)+(TB_STRIDE<<6)+(TB_BIAS_SCALE<<8)+
				 ...
				 (TB_MAP2_SIGNED<<24);
		conv_w2(str_in, str_out, str_in_map2,TB_NUM_FILTERS,TB_NUM_KERNEL,TB_INPUT_MAP_SIZE,TB_INPUT_MAP_SIZE,ctrl);
	...
	//		printf("%X\n",tmpa.data.range((DMA_WIDTH/4)-1,0).to_int());
			...
			printf("%X ",tmpa.data.range((DMA_WIDTH/4)*2-1,(DMA_WIDTH/4)).to_int());
			printf("%X ",tmpa.data.range((DMA_WIDTH/4)*3-1,(DMA_WIDTH/4)*2).to_int());
			printf("%X   i=%d\n",tmpa.data.range(DMA_WIDTH-1,(DMA_WIDTH/4)*3).to_int(),i);
