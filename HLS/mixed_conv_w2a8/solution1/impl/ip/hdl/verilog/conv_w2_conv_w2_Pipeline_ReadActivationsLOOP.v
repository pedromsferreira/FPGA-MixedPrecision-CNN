...
module conv_w2_conv_w2_Pipeline_ReadActivationsLOOP (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
output  [11:0] inputMap_V_address0;
...
wire   [31:0] saveAddr_8_fu_464_p3;
wire    ap_loop_init;
reg   [31:0] i_3_fu_90;
...
wire   [31:0] saveAddr_4_fu_421_p7;
wire   [31:0] saveAddr_7_fu_364_p2;
reg    ap_done_reg;
...
assign saveAddr_7_fu_364_p2 = (saveAddr_fu_86 + 32'd1);

assign saveAddr_8_fu_464_p3 = ((icmp_ln105_fu_376_p2[0:0] == 1'b1) ? saveAddr_4_fu_421_p7 : saveAddr_7_fu_364_p2);
...
endmodule //conv_w2_conv_w2_Pipeline_ReadActivationsLOOP
