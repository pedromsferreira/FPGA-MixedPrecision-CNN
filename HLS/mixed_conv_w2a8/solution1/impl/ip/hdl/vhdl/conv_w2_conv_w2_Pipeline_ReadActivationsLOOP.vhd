...
entity conv_w2_conv_w2_Pipeline_ReadActivationsLOOP is
port (
    ap_clk : IN STD_LOGIC;
    ap_rst : IN STD_LOGIC;
...
architecture behav of conv_w2_conv_w2_Pipeline_ReadActivationsLOOP is 
...
attribute shreg_extract : string;
    ...
    signal saveAddr_8_fu_464_p3 : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal saveAddr_4_fu_421_p7 : STD_LOGIC_VECTOR (31 downto 0);
    signal saveAddr_7_fu_364_p2 : STD_LOGIC_VECTOR (31 downto 0);
...
begin
    mux_53_32_1_1_U100 : component conv_w2_mux_53_32_1_1
    generic map (
        ID => 1,
        NUM_STAGE => 1,
        din0_WIDTH => 32,
        ...
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_boolean_0 = ap_block_pp0_stage0_11001) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0))) then
                if ((ap_loop_init = ap_const_logic_1)) then 
                    ...
                    saveAddr_fu_86 <= saveAddr_8_fu_464_p3;
                end if;
            end if; 
        end if;
    end process;
    ...
    begin
        if ((ap_const_boolean_1 = ap_condition_139)) then
            if ((or_ln98_2_fu_331_p2 = ap_const_lv1_1)) then 
                inputMap_V_address0 <= zext_ln61_fu_350_p1(12 - 1 downto 0);
            elsif ((or_ln98_2_fu_331_p2 = ap_const_lv1_0)) then 
                inputMap_V_address0 <= zext_ln71_fu_345_p1(12 - 1 downto 0);
            else 
    ...
    saveAddr_7_fu_364_p2 <= std_logic_vector(unsigned(saveAddr_fu_86) + unsigned(ap_const_lv32_1));
    saveAddr_8_fu_464_p3 <= 
        saveAddr_4_fu_421_p7 when (icmp_ln105_fu_376_p2(0) = '1') else 
        saveAddr_7_fu_364_p2;
