...
module conv_w2_conv_w2_Pipeline_ReadBiasStreamsLOOP_VITIS_LOOP_240_1 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
wire   [0:0] cmp6_i2922_mid1_fu_453_p2;
wire   [0:0] cmp6_i29221305_fu_458_p2;
...
assign cmp6_i29221305_fu_458_p2 = ((i_1_fu_142 < zext_ln239_cast_cast_reg_683) ? 1'b1 : 1'b0);

assign cmp6_i2922_mid1_fu_453_p2 = ((add_ln239_1_fu_447_p2 < zext_ln239_cast_cast_reg_683) ? 1'b1 : 1'b0);
...
assign select_ln232_1_fu_463_p3 = ((icmp_ln240_fu_433_p2[0:0] == 1'b1) ? cmp6_i2922_mid1_fu_453_p2 : cmp6_i29221305_fu_458_p2);
...
endmodule //conv_w2_conv_w2_Pipeline_ReadBiasStreamsLOOP_VITIS_LOOP_240_1
