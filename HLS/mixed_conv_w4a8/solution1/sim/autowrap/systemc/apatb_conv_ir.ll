; ModuleID = '/home/pferreira/HwSw/HLS/mixed_conv_w4a8/solution1/.autopilot/db/a.g.ld.5.gdce.bc'
...
define void @apatb_conv_ir(%"class.hls::stream<hls::axis<ap_int<128>, 0, 0, 0>, 0>"* noalias nocapture nonnull dereferenceable(32) %strm_in, %"class.hls::stream<hls::axis<ap_int<128>, 0, 0, 0>, 0>"* noalias nocapture nonnull dereferenceable(32) %strm_out, i32 %numFilters, i32 %numKernels, i32 %inputMapSizeX, i32 %inputMapSizeY, i32 %ctrl) local_unnamed_addr #0 {
entry:
  ...
  call void @apatb_conv_hw(i128* %strm_in_copy.data, i16* %strm_in_copy.keep, i16* %strm_in_copy.strb, i1* %strm_in_copy.last, i128* %strm_out_copy.data, i16* %strm_out_copy.keep, i16* %strm_out_copy.strb, i1* %strm_out_copy.last, i32 %numFilters, i32 %numKernels, i32 %inputMapSizeX, i32 %inputMapSizeY, i32 %ctrl)
...
declare void @apatb_conv_hw(i128*, i16*, i16*, i1*, i128*, i16*, i16*, i1*, i32, i32, i32, i32, i32)
...
define void @conv_hw_stub_wrapper(i128*, i16*, i16*, i1*, i128*, i16*, i16*, i1*, i32, i32, i32, i32, i32) #5 {
entry:
  ...
  call void @conv_hw_stub(%"class.hls::stream<hls::axis<ap_int<128>, 0, 0, 0>, 0>"* %13, %"class.hls::stream<hls::axis<ap_int<128>, 0, 0, 0>, 0>"* %14, i32 %8, i32 %9, i32 %10, i32 %11, i32 %12)
...
declare void @conv_hw_stub(%"class.hls::stream<hls::axis<ap_int<128>, 0, 0, 0>, 0>"*, %"class.hls::stream<hls::axis<ap_int<128>, 0, 0, 0>, 0>"*, i32, i32, i32, i32, i32)
