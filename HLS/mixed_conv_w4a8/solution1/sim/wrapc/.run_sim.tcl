...
proc sim {} {
	...
	set gWorkingDir          "../.."
	set constFileTvIn        "conv.autotvin.dat"
	set constFileTvOut       "conv.autotvout.dat"
	set constFileHdlTvIn     "conv.autohdltvin.dat"
	set constFileHdlTvOut    "conv.autohdltvout.dat"
	set gGateLevelSim        "0"
	set gAutowrap            "1"
	set gTool                "modelsim"
