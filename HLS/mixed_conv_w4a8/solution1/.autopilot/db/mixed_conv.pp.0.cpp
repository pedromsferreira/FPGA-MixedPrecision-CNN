# 1 "sources/mixed_conv_w4/mixed_conv.cpp"
# 1 "<built-in>" 1
# 1 "<built-in>" 3
# 375 "<built-in>" 3
# 1 "<command line>" 1
...
# 2 "<built-in>" 2
# 1 "sources/mixed_conv_w4/mixed_conv.cpp" 2
...
# 2 "sources/mixed_conv_w4/mixed_conv.cpp" 2
...
# 3 "sources/mixed_conv_w4/mixed_conv.cpp" 2
...
# 4 "sources/mixed_conv_w4/mixed_conv.cpp" 2
...
# 5 "sources/mixed_conv_w4/mixed_conv.cpp" 2
# 1 "sources/mixed_conv_w4/mixed_conv.h" 1
# 62 "sources/mixed_conv_w4/mixed_conv.h"
...
typedef ap_int<(128/((128/4)/(128/8)))> weight_bus_t;
# 81 "sources/mixed_conv_w4/mixed_conv.h"
...
typedef ap_int<8*4> mul_t;
typedef ap_int<32> accum_t;
# 6 "sources/mixed_conv_w4/mixed_conv.cpp" 2
...
#pragma HLS unroll
 ...
 weight_t filterValue = filterBus.range((i+1)*4 - 1,
                i*4);
...
# 53 "sources/mixed_conv_w4/mixed_conv.cpp"
 }

}

void save_padding_pixel(act_bus_t inputMap[((32 + 1*2)*(4 +1)*128/(128/8))],
...
void read_stream_activations(act_bus_t inputMap[((32 + 1*2)*(4 +1)*128/(128/8))],
        unsigned int initAddr,
...
void read_feature_map(act_bus_t inputMap[((32 + 1*2)*(4 +1)*128/(128/8))],
...
void read_feature_map_once(act_bus_t inputMap[((32 + 1*2)*(4 +1)*128/(128/8))],
       unsigned int inputMapSizeY,
       unsigned int streamsPerInputLine,
       unsigned int paddingIters,
       unsigned int padding,
...
void read_stream_weights(weight_bus_t filter[((4608/(128/8))*((128/4)/(128/8)))],
...
#pragma HLS INLINE
 ...
 stream_in_t tmp = strm_in.read();
 int numIters = (*perWeightCounter < ((128/4)/(128/8))) ? *perWeightCounter : ((128/4)/(128/8));
 *perWeightCounter -= numIters;

 WeightBusSeparationLOOP:
 for(int i = 0, idx = ((128/4)/(128/8))-1;
  i < ((128/4)/(128/8));
  i++, idx--) {
#pragma HLS unroll
 int upperLimit = (idx+1)*(128/((128/4)/(128/8)))-1;
  int lowerLimit = idx*(128/((128/4)/(128/8)));
...
void read_weights(weight_bus_t filter[(128/8)][((4608/(128/8))*((128/4)/(128/8)))],
...
void read_bias(bias_t bias[128],
      unsigned int totalBiasStreams,
      hls::stream<stream_in_t> &strm_in
      ) {
 stream_in_t tmp;

 int maxLimit = (128 -1)/(128/8)+1;
...
__attribute__((sdx_kernel("conv", 0))) void conv(hls::stream<stream_in_t> &strm_in,
...
#line 17 "/home/pferreira/HwSw/HLS/mixed_conv_w4a8/solution1/csynth.tcl"
#pragma HLSDIRECTIVE TOP name=conv
# 262 "sources/mixed_conv_w4/mixed_conv.cpp"

#line 6 "/home/pferreira/HwSw/HLS/mixed_conv_w4a8/solution1/directives.tcl"
#pragma HLSDIRECTIVE TOP name=conv
# 262 "sources/mixed_conv_w4/mixed_conv.cpp"
...
#pragma HLS INTERFACE s_axilite port=return bundle=BUS1
 ...
 weight_bus_t filter[(128/8)][((4608/(128/8))*((128/4)/(128/8)))];
 act_bus_t inputMap[((32 + 1*2)*(4 +1)*128/(128/8))];
 int inputMapLineAddr[4 +1];
 bias_t bias[128];
 accum_t accum[(128/8)];
...
#pragma HLS array_partition variable=accum type=complete
 ...
 unsigned int streamsPerWeight = (((numKernels-1)/(128/4))+1);
 ...
 int currInputMapAddr, currFilterAddr, saveInputMapAddr;
 int xOffsetMap, mapOverlapOffset, offsetFilter;
...
#pragma HLS pipeline II=1
 ...
 ap_uint<10> y_limit = (outMapSizeY < (32 + 1*2)) ? outMapSizeY : static_cast<ap_uint<10>>((32 + 1*2));
 ap_uint<10> x_limit = (outMapSizeX < (32 + 1*2)) ? outMapSizeX : static_cast<ap_uint<10>>((32 + 1*2));
 ap_uint<10> f_limit = (filtersPerPE < (128/(128/8))) ? filtersPerPE : static_cast<ap_uint<10>>(128/(128/8));
 ...
 unsigned int kn_limit = (numKernels < 128) ? numKernels : 128;
...
#pragma HLS unroll
 accum[peId] = 0;
       ...
       for(unsigned short peId = 0; peId < (128/8); peId++) {
#pragma HLS unroll
# 485 "sources/mixed_conv_w4/mixed_conv.cpp"
