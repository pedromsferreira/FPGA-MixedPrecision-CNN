...
eval "::AESL_LIB_XILADAPTER::xil_bram_gen { \
    ...
    corename inputMap_V \
    op interface \
    ports { inputMap_V_address0 { O 11 vector } inputMap_V_ce0 { O 1 bit } inputMap_V_we0 { O 1 bit } inputMap_V_d0 { O 128 vector } } \
} "
} else {
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_readLimit \
    op interface \
    ports { readLimit { I 32 vector } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_readLines_out \
    op interface \
    ports { readLines_out { O 32 vector } readLines_out_ap_vld { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    reset_level 1 \
    sync_rst true \
    corename dc_id_save_out \
    op interface \
    ports { id_save_out { O 32 vector } id_save_out_ap_vld { O 1 bit } } \
} "
}
