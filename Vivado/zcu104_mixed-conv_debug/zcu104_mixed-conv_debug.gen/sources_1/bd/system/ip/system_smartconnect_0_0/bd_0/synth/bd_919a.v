...
(* CORE_GENERATION_INFO = "bd_919a,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=bd_919a,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=35,numReposBlks=27,numNonXlnxBlks=0,numHierBlks=8,maxHierDepth=1,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=0,numPkgbdBlks=0,bdsource=SBD,synth_mode=Global}" *) (* HW_HANDOFF = "system_smartconnect_0_0.hwdef" *) 
module bd_919a
   (M00_AXI_araddr,
    M00_AXI_arburst,
    M00_AXI_arcache,
