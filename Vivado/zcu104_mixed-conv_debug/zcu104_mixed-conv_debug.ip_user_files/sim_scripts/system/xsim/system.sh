...
# Set xvlog options
xvlog_opts="--incr --relax  -L uvm -L axi_vip_v1_1_13 -L smartconnect_v1_0 -L zynq_ultra_ps_e_vip_v1_0_13 -L xilinx_vip"
...
{
  file="xsim.ini"
  lib_map_path="/home/mpv/tools/Xilinx/Vivado/2022.2/data/xsim"
  if [[ ($1 != "") ]]; then
    lib_map_path="$1"
  fi
